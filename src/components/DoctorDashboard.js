        ...
        <div className="contain">
            <Paper variant="outlined">
                ...
                <Grid container spacing={5} justify="space-around">
                    ...
                    <Grid item lg={6}>
                        <h2 id="table-header">Recent Patients</h2>
                    ...
                    <Grid item lg={6}>
                        ...
                        <br></br>
                        <Paper className={classes.drawerPaper} onClick={() => { history.push("/searchPatient") }}><h1>Search Patient</h1></Paper>
                        <br></br>
